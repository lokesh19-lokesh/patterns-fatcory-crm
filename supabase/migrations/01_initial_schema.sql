...
CREATE TABLE IF NOT EXISTS user_profiles (
    ...
    phone VARCHAR(20),
    role VARCHAR(50) NOT NULL CHECK (role IN ('Super Admin', 'Company Admin', 'Manager', 'Sales Executive', 'Purchase Manager', 'Warehouse Manager', 'HR', 'Accountant', 'Driver', 'Customer', 'Supplier')),
    avatar_url TEXT,
